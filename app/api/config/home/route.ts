...
const DEFAULT_CONFIGS: Record<string, any> = {
  ...
  sectionTitles: {
    ...
    hotRecipes: { title: "本周精选家常菜", subtitle: "热门推荐，一键开做", ctaLabel: "查看更多", ctaHref: "/recipe" },
    customRecipes: { title: "AI定制精选", subtitle: "看看别人都定制了什么", ctaLabel: "我也要定制 →", ctaHref: "/ai-custom" },
    themes: { title: "热门主题", subtitle: "精选食谱主题，找到你想要的", ctaLabel: "查看全部", ctaHref: "/recipe" },
    coreFeatures: { title: "为什么选择 Recipe Zen" },
    tools: { title: "让做饭更轻松的智能工具", subtitle: "从烹饪模式到语音提醒，让每一步都更从容。" },
    testimonials: { title: "用户怎么说", subtitle: "来自真实用户的反馈，温度与专业并存。" },
...
const DEFAULT_CONFIGS_EN: Record<string, any> = {
  ...
  sectionTitles: {
    ...
    hotRecipes: { title: "Weekly Picks", subtitle: "Trending recipes, one-click start", ctaLabel: "View more", ctaHref: "/recipe" },
    customRecipes: { title: "AI Custom Gallery", subtitle: "See what others have created", ctaLabel: "I Want to Customize Too →", ctaHref: "/ai-custom" },
    themes: { title: "Trending Themes", subtitle: "Pick a theme and start cooking", ctaLabel: "View all", ctaHref: "/recipe" },
    ...
    testimonials: { title: "What Users Say", subtitle: "Real voices, warmth and trust." },
